...
public final class MonthlyInventoryActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state){
        ...
        shareOnHand=button("4. Share File With All Users");shareOnHand.setOnClickListener(v->shareOnHand());root.addView(shareOnHand,params(54));
    ...
    private Button button(String s){Button b=new Button(this);b.setText(s);b.setTextSize(15);b.setTextColor(Color.WHITE);b.setAllCaps(false);b.setGravity(Gravity.CENTER);return b;}
